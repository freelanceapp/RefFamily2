package com.apps.reffamily.activities_fragments.activity_sign_up;
...
import com.apps.reffamily.databinding.ActivitySignUpBinding;
...
import com.apps.reffamily.models.SignUpModel;
...
public class SignUpActivity extends AppCompatActivity implements Listeners.SignUpListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void initView() {
        ...
        spinnerCategoryAdapter = new SpinnerCategoryAdapter(categoryList, this);
...
//        RequestBody account_number_part = Common.getRequestBodyText(signUpModel.getAccount_bank_number());
        ...
        Api.getService(Tags.base_url)
                .signUpWithoutImage(name_part, email_part, phone_code_part, phone_part, address_part, bannner, country_part, software_type_part, ipad_part, lat_part, lon_part, category_id_part)
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            if (response.body().getStatus() == 200) {
                                ...
                                if (response.body().getStatus() == 402) {
                                    ...
                                    Toast.makeText(SignUpActivity.this, getResources().getString(R.string.email_found), Toast.LENGTH_LONG).show();

                                } else {
                                    Toast.makeText(SignUpActivity.this, getResources().getString(R.string.failed), Toast.LENGTH_LONG).show();
                                }
                            }
